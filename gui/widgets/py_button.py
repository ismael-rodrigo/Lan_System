...
class PyPushButton(QPushButton):
    def __init__(
        ...
        self.border_is_active = border_is_active
    ...
    def set_style(
        ...
        if not self.border_is_active:
            ...
            if not is_active:
                self.setStyleSheet(style_border_active)
            else:
                self.setStyleSheet(style_border_active + active_style )
